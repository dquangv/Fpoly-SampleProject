 ...
 * @author Quang
 */
public class Learner_1 extends javax.swing.JDialog {
     ...
     */
    public Learner_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
        setStatus(true);
    ...
    public void load() {
        ...
        try {
            ...
            for (Model.Learner nh : list) {
                Object[] row = {nh.getMaNH(), nh.getHoTen(), nh.isGioiTinh() ? "Nam" : "Nữ", DateHelper.toString(nh.getNgaySinh()), nh.getDienThoai(), nh.getEmail(), nh.getMaNV(), DateHelper.toString(nh.getNgayDK()), nh.getTrinhDo()};
                model.addRow(row);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public void setModel(Model.Learner model) {
        ...
        if (model.getGioiTinh() == 0) {
            cbbNam.setSelected(true);
            cbbNu.setSelected(false);
        } else {
            cbbNam.setSelected(false);
            cbbNu.setSelected(true);
        }
        ...
        lblHinhAnh.setIcon(new ImageIcon(new ImageIcon(model.getHinhAnh()).getImage().getScaledInstance(lblHinhAnh.getWidth(), lblHinhAnh.getHeight(), 0)));

        if (model.getTrinhDo() == null) {
            rdoKhac.setSelected(true);
        } else if (model.getTrinhDo().equals("Cao đẳng")) {
...
//                int scaleHeight = (int) (img.getIconHeight() * scale);
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(cbbNam);
        cbbNam.setSelected(true);
        cbbNam.setText("Nam");

        buttonGroup1.add(cbbNu);
        cbbNu.setText("Nữ");
        ...
        rdoCaoDang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdoCaoDangActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(txtMaNH, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                .addComponent(txtDienThoai, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    .addComponent(jLabel7)
                                                    .addComponent(jLabel5)
                                                    .addComponent(txtEmail)
                                                    .addComponent(dayNgaySinh, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 609, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void tblLearnerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLearnerMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            this.index = tblLearner.rowAtPoint(evt.getPoint());
    ...
    private void rdoCaoDangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdoCaoDangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdoCaoDangActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Learner.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Learner_1 dialog = new Learner_1(new javax.swing.JFrame(), true);
